"""Inception3 model from torchvision/models.

Modified to extract features from the last hidden layer.
"""
...
def inception_v3(pretrained=False, model_path=None, **kwargs):
    """Inception v3 model architecture from arxiv 1512.00567.
